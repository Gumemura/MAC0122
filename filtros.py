...
#------------------------------------------------------------------
def pegaVizinhos(img, linhaImg, colImg, tamanho):
    raioVizinho = int(tamanho//2)

    ll1 = linhaImg - raioVizinho
    ll2 = linhaImg + raioVizinho + 1

    if ll1 < 0:
        ll1 = 0

    cc1 = colImg - raioVizinho
    cc2 = colImg + raioVizinho + 1

    if cc1 < 0:
        cc1 = 0

    return img[ll1:ll2, cc1:cc2]
